...
class Options():
    ...
    def initialize(self):
        ...
        # General options:
        # Resolve paths relative to the project root (parent of SMPLicit package)
        _this_dir = os.path.dirname(os.path.abspath(__file__))
        _project_root = os.path.dirname(_this_dir)
        self._parser.add_argument('--path_checkpoints', type=str, default=os.path.join(_project_root, 'checkpoints') + '/')
        self._parser.add_argument('--path_cluster_files', type=str, default=os.path.join(_project_root, 'clusters') + '/')
        self._parser.add_argument('--path_SMPL', type=str, default=os.path.join(_this_dir, 'utils', 'neutral_smpl_with_cocoplus_reg.pkl'))
